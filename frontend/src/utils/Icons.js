...
export const utilities = <i className="fa-solid fa-lightbulb"></i>
export const arrowup = <i class="fa-solid fa-arrow-up"></i>
export const arrowdown = <i class="fa-solid fa-arrow-down"></i>
export const list = <i class="fa-solid fa-list"></i>
